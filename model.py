...
class BARTDecoder(nn.Module):
    ...
    def prepare_inputs_for_inference(self, input_ids: torch.Tensor, encoder_outputs: torch.Tensor, past_key_values=None, use_cache: bool = None, attention_mask: torch.Tensor = None):
        """
        Args:
